...
public class OffersDAO {
	...
	public boolean create(Offer offer) {
		...
		return jdbc.update("insert into users (name, text, email) values (:name, :text, :email)", params) == 1;
	}
	...
	public int[] create(List<Offer> offers) {
		...
		return jdbc.batchUpdate("insert into users (id, name, text, email) values (:id, :name, :text, :email)", params);
	}
